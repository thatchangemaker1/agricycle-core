  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/thatchangemaker1/agricycle-core/blob/main/agricycle_sim_py.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "wYk6hxy08Si5",
        "outputId": "5ae0172f-8bce-4302-cff8-c9550f484c1c"
      },
      "outputs": [
        {
          "output_type": "stream",
          ...
          "text": [
            ...
            "      DIALING *384#...        \n",
            "==============================\n",
            "Enter your AgriCycle Farm ID (e.g., AGR-101): AGR-101\n",
            "\n",
            "[USSD] Welcome back, Bwalya Chanda (Chongwe)!\n",
            "\n",
            "--- AgriCycle USSD Main Menu ---\n",
            "1. Log Organic Waste / Biomass\n",
            "2. Check Carbon Credit Balance\n",
            "3. Exit Session\n",
            ...
            "1. Maize Stalks & Cobs\n",
            "2. Maize Cobs Only\n",
            "3. Other Agricultural Residues (e.g., Groundnut Shells)\n",
            "Select residue type (1-3): 2\n",
            "Enter weight of biomass diverted (in kg): 50\n",
            "\n",
            "[USSD] Success! Logged 50.0kg of Maize Cobs Only.\n",
            "[USSD] Estimated Carbon Offset: 25.00 kg CO2e.\n",
            "\n",
            "--------------------------------------------------\n",
            " [SMS GATEWAY SIMULATION] Outbound to: +260970000001\n",
            " MESSAGE: AgriCycle Update: Logged 50.0kg of Maize Cobs Only. Estimated Carbon Credit Earned: 25.00 kg CO2e. Thank you for building a circular economy!\n",
            "--------------------------------------------------\n",
            "\n",
            "--- AgriCycle USSD Main Menu ---\n",
            "1. Log Organic Waste / Biomass\n",
        ...
        },
        {
          ...
          "traceback": [
            ...
            "\u001b[0;32m/tmp/ipykernel_9036/1637354530.py\u001b[0m in \u001b[0;36m<cell line: 0>\u001b[0;34m()\u001b[0m\n\u001b[1;32m    176\u001b[0m \u001b[0;31m# --- PROGRAM ENTRY POINT ---\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[1;32m    177\u001b[0m \u001b[0;32mif\u001b[0m \u001b[0m__name__\u001b[0m \u001b[0;34m==\u001b[0m \u001b[0;34m\"__main__\"\u001b[0m\u001b[0;34m:\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[0;32m--> 178\u001b[0;31m     \u001b[0mverify_farm_id\u001b[0m\u001b[0;34m(\u001b[0m\u001b[0;34m)\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[0m",
            "\u001b[0;32m/tmp/ipykernel_9036/1637354530.py\u001b[0m in \u001b[0;36mverify_farm_id\u001b[0;34m()\u001b[0m\n\u001b[1;32m     74\u001b[0m         \u001b[0mfarmer\u001b[0m \u001b[0;34m=\u001b[0m \u001b[0mregistered_farms\u001b[0m\u001b[0;34m[\u001b[0m\u001b[0mfarm_id\u001b[0m\u001b[0;34m]\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[1;32m     75\u001b[0m         \u001b[0mprint\u001b[0m\u001b[0;34m(\u001b[0m\u001b[0;34mf\"\\n[USSD] Welcome back, {farmer['name']} ({farmer['location']})!\"\u001b[0m\u001b[0;34m)\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[0;32m---> 76\u001b[0;31m         \u001b[0mrun_ussd_session\u001b[0m\u001b[0;34m(\u001b[0m\u001b[0mfarm_id\u001b[0m\u001b[0;34m)\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[0m\u001b[1;32m     77\u001b[0m     \u001b[0;32melse\u001b[0m\u001b[0;34m:\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[1;32m     78\u001b[0m         \u001b[0mprint\u001b[0m\u001b[0;34m(\u001b[0m\u001b[0;34m\"\\n[USSD] Error: Farm ID not recognized.\"\u001b[0m\u001b[0;34m)\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n",
            "\u001b[0;32m/tmp/ipykernel_9036/1637354530.py\u001b[0m in \u001b[0;36mrun_ussd_session\u001b[0;34m(farm_id)\u001b[0m\n\u001b[1;32m    100\u001b[0m         \u001b[0mprint\u001b[0m\u001b[0;34m(\u001b[0m\u001b[0;34m\"3. Exit Session\"\u001b[0m\u001b[0;34m)\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[1;32m    101\u001b[0m \u001b[0;34m\u001b[0m\u001b[0m\n\u001b[0;32m--> 102\u001b[0;31m         \u001b[0mchoice\u001b[0m \u001b[0;34m=\u001b[0m \u001b[0minput\u001b[0m\u001b[0;34m(\u001b[0m\u001b[0;34m\"Choose an option (1-3): \"\u001b[0m\u001b[0;34m)\u001b[0m\u001b[0;34m.\u001b[0m\u001b[0mstrip\u001b[0m\u001b[0;34m(\u001b[0m\u001b[0;34m)\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[0m\u001b[1;32m    103\u001b[0m \u001b[0;34m\u001b[0m\u001b[0m\n\u001b[1;32m    104\u001b[0m         \u001b[0;32mif\u001b[0m \u001b[0mchoice\u001b[0m \u001b[0;34m==\u001b[0m \u001b[0;34m\"1\"\u001b[0m\u001b[0;34m:\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n",
